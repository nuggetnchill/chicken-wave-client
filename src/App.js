...
const App = () => {
  ...
  const contractAddress = "0x70a48B4789C3cEC0142590C6dd9721929ebaE245";
  ...
  const getAllWaves = async () => {
    try {
      ...
      if(ethereum){
        ...
        const chickenWaveContract = new ethers.Contract(contractAddress, contractABI, signer);
  ...
  const wave = async () => {
    try{
      ...
      if(ethereum){
        ...
        const waveTxn = await chickenWaveContract.wave(waveMessage, {gasLimit: 300000});
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        ...
        {numberOfYeets &&(<div className="total-yeet">
          Total Yeets: {numberOfYeets}
        </div>)}
        
    
        {!currentAccount &&(<div className="bio">
         Connect your wallet in order to yeet!
        </div>)}
